...
<div className="flex items-center justify-center p-6 border-b border-gray-300 lg:justify-between">
  ...
  <div className="flex justify-center">
    <a href="#!" className="mr-6 text-gray-600 iconset">
    ...
    <a href="#!" className="mr-6 text-gray-600 iconset">
      <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter"
        className="w-9" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        <path fill="currentColor"
    ...
    <a href="#!" className="mr-6 text-gray-600 iconset">
      <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google"
        className="w-8" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512">
        <path fill="currentColor"
    ...
    <a href="#!" className="mr-6 text-gray-600 iconset">
      <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="instagram"
        className="w-8" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        <path fill="currentColor"
    ...
    <a href="#!" className="mr-6 text-gray-600 iconset">
      <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="linkedin-in"
        className="w-8" role="img" xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 448 512">
        <path fill="currentColor"
...
<div className="py-10 mx-6 text-center md:text-left">
  <div className="grid gap-8 grid-1 md:grid-cols-2 lg:grid-cols-4">
    <div className="">
      ...
      <p>
        Our large community has vast level of experts in both AI and Robotics who are working both on board and off board.
        Large amount of them has industrial experience that will guide you to your journey.
      </p>
    </div>
    <div className="">
      ...
      <p className="mb-4">
        <a href="#!" className="text-gray-600">Artifical Intelligence</a>
      </p>
      <p className="mb-4">
        <a href="#!" className="text-gray-600">Image Processing</a>
      </p>
      <p className="mb-4">
        <a href="#!" className="text-gray-600">Robotics</a>
      </p>
      <p>
        <a href="#!" className="text-gray-600">Circuits and Electronics</a>
      </p>
    </div>
    <div className="">
      <h6 className="flex justify-center mb-4 font-semibold uppercase md:justify-start">
...
<div className="p-6 text-center bg-gray-200">
  <span>&copy;2022 Connecteen. All rights reserved.</span>
