  ...
  return (
    ...
    <nav className="flex items-center justify-between flex-wrap bg-blue-500 p-6">
      <div className="flex items-center flex-shrink-0 text-white mr-6">
        <span className="font-semibold text-xl tracking-tight">Connecteen</span>
      </div>
      ...
      <div className="w-full block flex-grow sm:flex lg:items-center ">
        <div className="text-sm lg:flex-grow" style={fontStyleBanner}>
          Join the most advanced community of Bangladesh
        </div>
        <div>
          <a href="/login" style = {joinNow}
            className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-blue-500 hover:bg-white mt-4 lg:mt-0">Join Today</a>
        </div>
      </div>
    </nav>
...
/*
      ...
      <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        ...
        <div>
          <a href="#"
            className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-blue-500 hover:bg-white mt-4 lg:mt-0">Download</a>
        </div>
      </div>
